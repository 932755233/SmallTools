...
public class DesUtils {
	...
	private static String fKey = "sunny";/* 必需的密钥 */
	private static String sKey = "sunny";
	private static String tKey = "120";
	...
	public static void main(String[] args) {
		...
		DesUtils en = new DesUtils();
		
		
		String data = "\"dsf\":\"wqewqewq\"";//"547EE3F79A20698FE7638B9D393CD45B";
		String strs = en.strEncode(data);
		String decs = en.strDecode(strs);
	...
	public static String strEncode(String data) {
		...
		String encData = "";
		List fKeyBt = null, sKeyBt = null, tKeyBt = null;
		int firstLength = 0, secondLength = 0, thirdLength = 0;
		if (fKey != null && fKey != "") {
			fKeyBt = getKeyBytes(fKey);
			firstLength = fKeyBt.size();
		}
		if (sKey != null && sKey != "") {
			sKeyBt = getKeyBytes(sKey);
			secondLength = sKeyBt.size();
		}
		if (tKey != null && tKey != "") {
			tKeyBt = getKeyBytes(tKey);
			thirdLength = tKeyBt.size();
		}
		...
		if (leng > 0) {
			if (leng < 4) {
				int[] bt = strToBt(data);
				int[] encByte = null;
				if (fKey != null && fKey != "" && sKey != null && sKey != "" && tKey != null && tKey != "") {
					int[] tempBt;
					int x = 0, y = 0, z = 0;
					tempBt = bt;
					for (x = 0; x < firstLength; x++) {
						tempBt = enc(tempBt, (int[]) fKeyBt.get(x));
					}
					for (y = 0; y < secondLength; y++) {
						tempBt = enc(tempBt, (int[]) sKeyBt.get(y));
					}
					for (z = 0; z < thirdLength; z++) {
						tempBt = enc(tempBt, (int[]) tKeyBt.get(z));
					}
					encByte = tempBt;
				} else {
					if (fKey != null && fKey != "" && sKey != null && sKey != "") {
						int[] tempBt;
						int x = 0, y = 0;
						tempBt = bt;
						for (x = 0; x < firstLength; x++) {
		...
		for (i = 0; i < iterator; i++) {
			...
			if (fKey != null && fKey != "" && sKey != null && sKey != "" && tKey != null && tKey != "") {
				...
				for (x = thirdLength - 1; x >= 0; x--) {
					tempBt = dec(tempBt, (int[]) tKeyBt.get(x));
				}
				for (y = secondLength - 1; y >= 0; y--) {
					tempBt = dec(tempBt, (int[]) sKeyBt.get(y));
				}
				for (z = firstLength - 1; z >= 0; z--) {
					tempBt = dec(tempBt, (int[]) fKeyBt.get(z));
				}
				decByte = tempBt;
			} else {
				if (fKey != null && fKey != "" && sKey != null && sKey != "") {
					...
					for (x = secondLength - 1; x >= 0; x--) {
						tempBt = dec(tempBt, (int[]) sKeyBt.get(x));
					}
					for (y = firstLength - 1; y >= 0; y--) {
						tempBt = dec(tempBt, (int[]) fKeyBt.get(y));
					}
					decByte = tempBt;
				} else {
					if (fKey != null && fKey != "") {
						...
						for (x = firstLength - 1; x >= 0; x--) {
							tempBt = dec(tempBt, (int[]) fKeyBt.get(x));
						}
						decByte = tempBt;
					}
				}
